    ...
    render() {
        ...
        return (
            <Page>
                ...
                <Text type={TextType.secondaryDescription} margin={createMargin(0, 0, 18, 0, Dimension.px)} text={"Hello world, Hello world, Hello world, Hello world, Hello world, Hello world, Hello world, Hello world, Hello world, Hello world, Hello world, Hello world, Hello world, Hello world"}/>
                <Wrapper>
