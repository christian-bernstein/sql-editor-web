...
import {AnalysisFacet} from "../../../../driver/AnalysisFacet";
import {Box} from "../../components/lo/Box";
import {equals, When} from "../../components/logic/When";
        ...
        this.assembly.assembly("test", (theme, props) => {
            ...
            return (
                <Flex fw elements={[
                    ...
                    <Button text={"Update facet"} onClick={() => {
                        this.dialog(
                            <StringQuery title={"New facet value"} onSubmit={string => {
                                driver().analyticsManager.updateFacet("test", string);
                            }}/>
                        );
                    }}/>,
