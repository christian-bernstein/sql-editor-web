    ...
    componentRender(p: MarkdownDocumentViewProps, s: any, l: MarkdownDocumentViewLocalState, t: Themeable.Theme, a: Assembly): JSX.Element | undefined {
        ...
        return (
            <OverflowWithHeader
                ...
                staticContainer={{
                    ...
                    elements: [
                        <Box
                            ...
                            elements={[
                                <Flex flexDir={FlexDirection.ROW} align={Align.CENTER} fw gap={t.gaps.smallGab} elements={[
                ...
                overflowContainer={{
                    elements: [
                        <LiteGrid gap={px()} height={percent(100)} columns={2} children={
                            <AF elements={[
                                <Flex
                                    fw
                                    fh
                                    ...
                                    padding={true}
                                    paddingX={px()}
                                    style={{ backgroundColor: t.colors.backgroundHighlightColor.toHex(), paddingRight: t.gaps.defaultGab.css() }}
                                    gap={px()}
