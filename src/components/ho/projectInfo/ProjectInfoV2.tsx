...
export type ProjectInfoV2Props = {
    data: ProjectInfoData,
    ctx: ProjectPreviewContext
}

export type ProjectInfoV2LocalState = {
    body: string
}

export class ProjectInfoV2 extends BernieComponent<ProjectInfoV2Props, any, ProjectInfoV2LocalState> {

    constructor(props: ProjectInfoV2Props) {
    ...
    componentRender(p: ProjectInfoV2Props, s: any, l: ProjectInfoV2LocalState, t: Themeable.Theme, a: Assembly): JSX.Element | undefined {
